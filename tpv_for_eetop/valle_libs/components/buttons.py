...
class ButtonIcon(ButtonBase):
    ...
    icon_scale = ObjectProperty("30dp")

    def get_font_size_icon(self):
        return  dp(self.font_size.replace('dp','')) + dp(self.icon_scale.replace('dp',''))

    def set_font_size_icon(self, val):
        pass

    font_size_icon = AliasProperty(get_font_size_icon, set_font_size_icon, bind=["font_size", "icon_scale"])
